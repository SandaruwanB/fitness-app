...
<head>
    ...
    <title>GYM | Place to gain muscles</title>
...
<body>
  ...
  <section class="hero-section">
    <div class="hs-slider owl-carousel">
        <div class="hs-item set-bg" data-setbg="/core/images/hero-1.jpg">
            <div class="container">
                <div class="row">
        ...
        <div class="hs-item set-bg" data-setbg="/core/images/hero-2.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-6">
                        <div class="hi-text">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6">
                <div class="cs-item">
                    ...
                    <p>Multi-purpose machines for functional fitness and core stability exercises.</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="cs-item">
                    ...
                    <p>A healthy nutrition plan focuses on eating a variety of whole, unprocessed foods like fruits, vegetables, lean proteins, whole grains, and healthy fats.</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="cs-item">
                    ...
                    <p>improve overall performance levels, allowing them to compete at the highest level possible.</p>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="cs-item">
                    ...
                    <p>help to achieve the best possible outcomes based on your unique circumstances.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="/core/images/class-1.jpg" alt="">
                    </div>
                    <div class="ci-text">
                        <span>STRENGTH</span>
                        <h5>Weightlifting</h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="/core/images/class-2.jpg" alt="">
                    </div>
                    <div class="ci-text">
                        <span>Cardio</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="/core/images/class-3.jpg" alt="">
                    </div>
                    <div class="ci-text">
                        <span>STRENGTH</span>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="/core/images/class-4.jpg" alt="">
                    </div>
                    <div class="ci-text">
                        <span>Cardio</span>
            ...
            <div class="col-lg-6">
                <div class="class-item">
                    <div class="ci-pic">
                        <img src="/core/images/class-5.jpg" alt="">
                    </div>
                    <div class="ci-text">
                        <span>Training</span>
                        <h4>Boxing</h4>
  ...
  <section class="banner-section set-bg" data-setbg="/core/images/banner-bg.jpg">
    <div class="container">
        <div class="row">
